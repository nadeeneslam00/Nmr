...
export default function ViewSeats() {
    ...
    function handleSelect(e) {
        ...
        axios.post('http://localhost:5000/reserve', resrvation).then(() => {
            console.log("yaaayy")
    ...
    useEffect(() => {
        ...
        axios.post('http://localhost:5000/getTempChosenFlights', getDep,{
            ...
            axios.post('http://localhost:5000/getBussinessSeats', depFlight).then((response) => {
        ...
        axios.post('http://localhost:5000/getTempChosenFlights', getRet,{
            ...
            axios.post('http://localhost:5000/getBussinessSeats', retFlight).then((response) => {
                //Sconsole.log(response.data);
